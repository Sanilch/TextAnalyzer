...
<div className="form-check form-switch">
  <input className="form-check-input my-3" type="checkbox" id="flexSwitchCheckChecked" onClick={toggleMode}/>
  <label className="form-check-label my-3" for="flexSwitchCheckChecked">{btnText}</label>
</div>
